...
<html lang="es">
  <head>
    ...
    <meta
      name="description"
      content="Hotel Miranda: Enjoy the ultimate coastal experience in our comfortable facilities. Located on the beautiful coast, Hotel Miranda is your perfect destination for a relaxing vacation."
    />
          ...
          <nav class="header__nav">
            ...
            <ul class="header__nav-list">
              <li class="header__nav-item">
                <a class="header__nav-link" href="./about_us" aria-label="go to About-us"
                  >About Us
                </a>
              </li>
              <li class="header__nav-item">
                <a class="header__nav-link" href="./room.blade.php" aria-label="go to Rooms">Rooms </a>
              </li>
              <li class="header__nav-item">
                <a class="header__nav-link" href="./our_offer.blade.phpl" aria-label="go to Offers"
                  >Offers
                </a>
              </li>
              <li class="header__nav-item">
        ...
        <div class="footer__container wrapper2">
          <div>
            <div class="header__logo">
              <img
                class="header__image footer__logo"
                src="./assets/images/footer/logo2.svg"
                alt="hotel miranda logo"
              />
          ...
          <div class="contact">
            ...
            <ul class="contact__list">
              ...
              <li class="contact__item">
                <img
                  class="contact__img"
                  src="./assets/images/footer/location-2.svg"
                  alt="phone icon"
                  loading="lazy"
                />
                <p class="contact__subtitle old">
