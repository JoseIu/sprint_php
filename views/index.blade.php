      ...
      <section class="about wrapper">
        ...
        <div class="about__images">
          <article class="card card--order">
            <img
              class="card__image card__image--order"
            ...
            <div class="card__content card__content--bg">
              <img
                ...
                src="./assets/images/card-people.svg"
                alt="people image"
              />
      ...
      <section class="rooms wrapper">
        ...
        <div class="swiper">
          ...
          <div class="swiper-button-prev">
            <img
              class="slider__arrow"
              src="./assets/images/rooms/arrow-left.svg"
              alt="arrow icon"
              loading="lazy"
            />
          </div>
          <div class="swiper-button-next">
            <img
              class="slider__arrow"
              src="./assets/images/rooms/arrow-right.svg"
              alt="arrow icon"
              loading="lazy"
            />
          </div>
      ...
      <section class="features">
        ...
        <div class="features__list">
          ...
          <article class="feature">
            <img
              class="feature__img"
              src="./assets/images/features/starts.svg"
              alt="rating icon"
              loading="lazy"
            />
        ...
        <div class="foods__containe wrapper2">
          ...
          <div class="foods__list">
            ...
            <article class="food">
              <img
                class="food__img"
                src="./assets/images/foods/food-1.webp"
                loading="lazy"
                alt="food"
              />
            ...
            <article class="food">
              <img
                class="food__img"
                src="./assets/images/foods/food-2.webp"
                loading="lazy"
                alt="food"
              />
              <div class="food__content">
            ...
            <article class="food">
              <img
                class="food__img"
                src="./assets/images/foods/food-3.webp"
                loading="lazy"
                alt="food"
              />
              <div class="food__content">
            ...
            <article class="food">
              <img
                class="food__img"
                src="./assets/images/foods/food-4.webp"
                loading="lazy"
                alt="food"
              />
              <div class="food__content">
            ...
            <article class="food">
              <img
                class="food__img"
                src="./assets/images/foods/food-5.webp"
                loading="lazy"
                alt="food"
              />
              <div class="food__content">
            ...
            <article class="food">
              <img
                class="food__img"
                src="./assets/images/foods/food-6.webp"
                loading="lazy"
                alt="food"
              />
              <div class="food__content">
      ...
      <div class="benefies wrapper2">
        <div class="benefies__list">
          ...
          <article class="benefie">
            <img
              class="benefie__img"
              src="./assets/images/foods/rocket.svg"
              alt="benefies rocket image"
              loading="lazy"
            />
          ...
          <article class="benefie">
            <img
              class="benefie__img"
              src="./assets/images/foods/people.svg"
              alt="benefies rocket image"
              loading="lazy"
            />
          ...
          <article class="benefie">
            <img
              class="benefie__img"
              src="./assets/images/foods/grafic.svg"
              alt="benefies rocket image"
              loading="lazy"
            />
          ...
          <article class="benefie">
            <img
              class="benefie__img"
              src="./assets/images/foods/book.svg"
              alt="benefies rocket image"
              loading="lazy"
            />
